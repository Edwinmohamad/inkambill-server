...
router.get('/',async(req,res,next)=>{try{
  const [results,olts]=await Promise.all([
    Promise.all([
  ...
  res.render('noc/index',{title:'NOC Terpadu',routers:results[0][0][0]||{},onts:results[1][0][0]||{},customers:results[2][0][0]||{},tickets:results[3][0][0]||{},sites:results[4][0],alarms:results[5][0],lastSync:results[6][0][0]||null,olts});
}catch(err){next(err);}});

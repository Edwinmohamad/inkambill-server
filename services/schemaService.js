...
async function ensureV35Schema() {
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS closing_router_assets (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,customer_name VARCHAR(180) NOT NULL,site_code VARCHAR(30) NOT NULL DEFAULT 'CLM',owner_name VARCHAR(100) NOT NULL,units INT UNSIGNED NOT NULL DEFAULT 1,active_from DATE NOT NULL,active_until DATE NULL,status ENUM('ACTIVE','BROKEN','REPLACED','INACTIVE') NOT NULL DEFAULT 'ACTIVE',notes TEXT NULL,created_by BIGINT UNSIGNED NULL,created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,INDEX idx_router_asset_period(active_from,active_until),INDEX idx_router_asset_owner(owner_name))`);
...
module.exports = { ensureV14Schema, ensureV15Schema, ensureV16Schema, ensureV17Schema, ensureV18Schema, ensureV19Schema, ensureV20Schema, ensureV21Schema, ensureV22Schema, ensureV23Schema, ensureV24Schema, ensureV25Schema, ensureV26Schema, ensureV27Schema, ensureV29Schema, ensureV30Schema, ensureV31Schema, ensureV32Schema, ensureV33Schema, ensureV34Schema, ensureV35Schema };
